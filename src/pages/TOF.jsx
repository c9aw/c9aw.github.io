...
const TOF = () => {
  return (
    <div className=''>
      <div className='w-1/2 mx-auto py-10 flex flex-col gap-6'>
        <p className='text-black text-4xl font-bold text-center py-10'>
          Terms of Service
        </p>
        ...
        <ul className='list-disc ml-10'>
          ...
          <li>
            ...
            Account, create an Account using a false identity or information, or
            on behalf of someone other than yourself; You shall not use the
            Service if you have previously been removed by Beluga, or previously
            been banned from playing any Beluga game.
          </li>
          <li>
            You shall not use the Service to advertise, or solicit, or transmit
            any commercial advertisements, including chain letters, junk or spam
